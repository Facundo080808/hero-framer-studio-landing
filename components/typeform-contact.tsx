  ...
  plans = [
    {
      ...
      name: "Startup",
      price: "",
      description: "Perfeito para freelancers e pequenos negócios que querem marcar presença online",
      features: [
        "1 Landing Page profissional",
        "Design responsivo premium",
        "Animações modernas incluídas",
        "Botão WhatsApp integrado",
        "Formulário de contato redireccionado por whatsapp so",
        "Entrega em 15 dias úteis",
        "2 revisões incluídas",
        "Suporte via WhatsApp no horário comercial (09:00 até 18:00) "
      ],
    },
    {
      id: "grow",
      name: "PROFISSIONAL",
      price: "",
      description: "Ideal para profissionais liberais e empresas que querem resultados rápidos",
      features: [
        "Tudo do plano Starter +",
        "Seção de depoimentos profissional",
        "Formulário avançado com email",
        "Entrega EXPRESS em 10 dias",
    ...
    },
    {
      ...
      name: "PREMIUM",
      price: "",
      description: "Para empresas que não abrem mão da excelência e querem dominar o mercado",
      features: [
        "Tudo do plano Profissional +",
        "Seção FAQ completa",
        "Otimização SEO Básica",
        "Entrega SUPER EXPRESS em 7 dias",
    ...
    },
    {
      ...
      name: "ENTERPRISE ",
      price: "",
      description: "A escolha de empresas que querem ser líderes no seu segmento",
      features: [
        "Tudo do plano Premium +",
        "Dashboard administrativo de conteúdo estático ( R$150 fee mensal por separado)",
        "Integração com CRM Próprio (R$150 fee mensal por separado)",
        "Entrega ULTRA EXPRESS em 7 dias ",
        "10 revisões incluídas",
        "Suporte por 45 dias ",
      ],
    },
  ],
